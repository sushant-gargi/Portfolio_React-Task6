    ...
    return (
        <div className='work1'>
            ...
            <div className="right">
                ...
                <div className="link">
                    <a id='yep' href="https://word-counter-react-task1-ovo4ih4l1-sushant-gargis-projects.vercel.app" target='_blank'>WordCounter-App</a>
                </div>
            </div>
            ...
            <div className="work2">
                <div className="right">
                    ...
                    <div className="link1">
                        <a id='yep1' href="https://calculator-react-inw2f50lw-sushant-gargis-projects.vercel.app" target='_blank'>Calculator-App</a>
                    </div>
                </div>
                <div className="side">
            ...
            <div className="work3">
                ...
                <div className="right">
                    ...
                    <div className="link3">
                        <a id='yep3' href="https://age-calculator-react-task5-4ynlc7tk6-sushant-gargis-projects.vercel.app" target='_blank'>AgeCheck-App</a>
                    </div>
                </div>
            </div>
            ...
            <div className="work4">
                <div className="right">
                    ...
                    <div className="link4">
                        <a id='yep4' href="https://colour-picker-react-task3-msbrkx5ls-sushant-gargis-projects.vercel.app" target='_blank'>ColorPicker-App</a>
                    </div>
                </div>
                <div className="side">
